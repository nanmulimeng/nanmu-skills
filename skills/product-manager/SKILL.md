...
description: 产品经理技能 - 需求分析、功能规划、用户体验评估、竞品分析、增长策略、商业模式设计。当你涉及功能规划、需求评估、优先级排序、用户体验分析、竞品对比、版本规划时必须使用此技能。即使用户只是说"加个功能"或"这个需求怎么做"，也应触发。如果未自动触发，手动写：`使用 product-manager`。
---
